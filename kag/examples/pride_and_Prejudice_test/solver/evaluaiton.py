...
if __name__ == "__main__":
    ...
    with open(r"solver\data\pride_and_Prejudice_qa.json", "r", encoding="utf-8") as f:
    ...
    # Save results
    with open(r"solver\data\pride_and_Prejudice_qa_rag.json", "w", encoding="utf-8") as f:
